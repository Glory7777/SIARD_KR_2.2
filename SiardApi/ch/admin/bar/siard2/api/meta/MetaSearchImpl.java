  ...
  implements MetaSearch
{
  ...
  public void find(String sFindString, boolean bMatchCase) throws IOException {
    _il.enter(new Object[] { sFindString, String.valueOf(bMatchCase), getClass().getName() });
  ...
  public MetaSearch findNext(DU du) throws IOException {
    _il.enter(new Object[] { getClass().getName() });
    ...
    if (this._sFindString != null) {
      ...
      while (msFind == null && this._iFoundElement < asElement.length) {
        ...
        if (sElement != null) {
          ...
          if (this._bMatchCase) {
            ...
            _il.event("Found in \"" + sElement + "\" " + String.valueOf(this._iFoundElement) + " at position " + String.valueOf(iPos));
            msFind = this;
      ...
      if (msFind == null) {
        ...
        _il.event("Element: " + String.valueOf(this._iFoundElement) + " / Offset: " + String.valueOf(this._iFoundOffset));
      } 
...
/* Location:              C:\Users\lenovo\IdeaProjects\SIARD_KR_2.2\lib\siardapi.jar!\ch\admin\bar\siard2\api\meta\MetaSearchImpl.class
