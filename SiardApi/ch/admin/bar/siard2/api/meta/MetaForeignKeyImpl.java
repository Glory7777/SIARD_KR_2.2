  ...
  implements MetaForeignKey
{
  ...
  public String getColumn(int iColumn) {
    return XU.fromXml(((ReferenceType)this._fkt.getReference().get(iColumn)).getColumn());
  }
  public String getReferenced(int iColumn) {
    return XU.fromXml(((ReferenceType)this._fkt.getReference().get(iColumn)).getReferenced());
  }
...
/* Location:              C:\Users\lenovo\IdeaProjects\SIARD_KR_2.2\lib\siardapi.jar!\ch\admin\bar\siard2\api\meta\MetaForeignKeyImpl.class
