  ...
  implements MetaValue
{
  ...
  protected MetaSearch[] getSubMetaSearches() throws IOException {
    ...
    for (int iField = 0; iField < getMetaFields(); iField++)
      ams[iField] = (MetaSearch)getMetaField(iField); 
    return ams;
  }
}


/* Location:              C:\Users\lenovo\IdeaProjects\SIARD_KR_2.2\lib\siardapi.jar!\ch\admin\bar\siard2\api\meta\MetaValueImpl.class
