  ...
  implements MetaRoutine
{
  ...
  private final Map<String, MetaParameter> _mapMetaParameters = new HashMap<>();
      ...
      if (getMetaParameter(sName) == null) {
        ...
        if (this._rtTemplate != null) {
          ...
          if (ptsTemplate != null) {
            ...
            if (ptTemplate != null && mp instanceof MetaParameterImpl mpi) {
...
/* Location:              C:\Users\lenovo\IdeaProjects\siardapi.jar!\ch\admin\bar\siard2\api\meta\MetaRoutineImpl.class
