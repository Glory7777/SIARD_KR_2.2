...
public class MetaTypeImpl extends MetaSearchImpl implements MetaType {
  ...
  private static final ObjectFactory _of = new ObjectFactory(); private static final long lMEGA = 1048576L; private static final long lGIGA = 1073741824L;
  private final Map<String, MetaAttribute> _mapMetaAttributes = new HashMap<>();
      ...
      if (getMetaAttribute(sName) == null) {
        ...
        if (this._ttTemplate != null) {
          ...
          if (atsTemplate != null) {
            ...
            if (atTemplate != null && ma instanceof MetaAttributeImpl mai) {
...
/* Location:              C:\Users\lenovo\IdeaProjects\siardapi.jar!\ch\admin\bar\siard2\api\meta\MetaTypeImpl.class
