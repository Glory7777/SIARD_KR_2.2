  ...
  implements RecordDispenser
{
  ...
  public void skip(long lSkip) throws IOException {
    ...
    catch (XMLStreamException xse) { throw new IOException(lSkip + " records starting with " + this._lRecord + " could not be skipped (" + EU.getExceptionMessage(xse) + ")!"); }
...
/* Location:              C:\Users\lenovo\IdeaProjects\siardapi.jar!\ch\admin\bar\siard2\api\primary\RecordDispenserImpl.class
