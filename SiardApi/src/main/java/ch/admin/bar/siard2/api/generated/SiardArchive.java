...
import ch.admin.bar.siard2.api.generated.old21.PrivilegesType;
import ch.admin.bar.siard2.api.generated.old21.RolesType;
...
public class SiardArchive
{
  ...
  @XmlElement(namespace = "http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd", required = true)
  protected ch.admin.bar.siard2.api.generated.SchemasType schemas;
  @XmlElement(namespace = "http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd", required = true)
  protected ch.admin.bar.siard2.api.generated.UsersType users;
  @XmlElement(namespace = "http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd")
  protected ch.admin.bar.siard2.api.generated.RolesType roles;
  @XmlElement(namespace = "http://www.bar.admin.ch/xmlns/siard/2/metadata.xsd")
  protected ch.admin.bar.siard2.api.generated.PrivilegesType privileges;
  ...
  public ch.admin.bar.siard2.api.generated.SchemasType getSchemas() {
//  public SchemasType getSchemas() {
  ...
  public void setSchemas(ch.admin.bar.siard2.api.generated.SchemasType value) {
    this.schemas = value;
  }
  ...
  public ch.admin.bar.siard2.api.generated.UsersType getUsers() {
    return this.users;
  }
  ...
  public void setUsers(ch.admin.bar.siard2.api.generated.UsersType value) {
    this.users = value;
  }
  ...
  public ch.admin.bar.siard2.api.generated.RolesType getRoles() {
    return this.roles;
  }
  ...
  public void setRoles(ch.admin.bar.siard2.api.generated.RolesType value) {
    this.roles = value;
  }
  ...
  public ch.admin.bar.siard2.api.generated.PrivilegesType getPrivileges() {
  ...
  public void setPrivileges(ch.admin.bar.siard2.api.generated.PrivilegesType value) {
...
/* Location:              C:\Users\lenovo\IdeaProjects\siardapi.jar!\ch\admin\bar\siard2\api\generated\SiardArchive.class
