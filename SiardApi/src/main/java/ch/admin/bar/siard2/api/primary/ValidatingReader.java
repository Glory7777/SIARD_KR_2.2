  ...
  public ValidatingReader(Element el, InputStream is) {
    if (is == null) {
      this._rdr = new StringReader(XU.fromXml(el));
        ...
        this._rdr = new InputStreamReader(new ValidatingInputStream(el, is, false), StandardCharsets.UTF_8);
...
/* Location:              C:\Users\lenovo\IdeaProjects\siardapi.jar!\ch\admin\bar\siard2\api\primary\ValidatingReader.class
