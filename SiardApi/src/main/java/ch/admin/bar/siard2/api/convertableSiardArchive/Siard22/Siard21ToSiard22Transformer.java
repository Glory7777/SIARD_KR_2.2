...
public class Siard21ToSiard22Transformer implements Siard21Transformer {
  ...
  public SiardArchive visit(ConvertableSiard21Archive siard21Archive) {
    ...
    return new ConvertableSiard22Archive("2.2",
            ...
            convertElements(
                    ...
                    md -> md.accept(Siard21ToSiard22Transformer.this)
            ),
            convertElements(
  ...
  public ConvertableSiard22TypeType visit(ConvertableSiard21TypeType siard21Type) {
    return new ConvertableSiard22TypeType(
            siard21Type.getName(),
            ...
            safeConvert(
                    siard21Type.getCategory(),
                    ch.admin.bar.siard2.api.generated.CategoryType::value,
                    ch.admin.bar.siard2.api.generated.CategoryType::fromValue
            ),
            convertElements(
                    siard21Type.getAttributes(),
  ...
  public ConvertableSiard22ForeignKeyTypes visit(ConvertableSiard21ForeignKeyTypes siard21ForeignKey) {
    return new ConvertableSiard22ForeignKeyTypes(siard21ForeignKey.getName(), siard21ForeignKey
        .getDescription(), 
        safeConvert(siard21ForeignKey.getMatchType(), MatchTypeType::value, ch.admin.bar.siard2.api.generated.MatchTypeType::fromValue),
        safeConvert(siard21ForeignKey.getDeleteAction(), ReferentialActionType::value, ch.admin.bar.siard2.api.generated.ReferentialActionType::fromValue),
        safeConvert(siard21ForeignKey.getUpdateAction(), ReferentialActionType::value, ch.admin.bar.siard2.api.generated.ReferentialActionType::fromValue), siard21ForeignKey
  ...
  public ConvertableSiard22PriviligeType visit(ConvertableSiard21PriviligeType privilige) {
    return new ConvertableSiard22PriviligeType(privilige.getType(), privilige
        ...
        .getObject(), 
        safeConvert(privilige.getOption(), PrivOptionType::value, ch.admin.bar.siard2.api.generated.PrivOptionType::fromValue));
  }
  ...
  public ConvertableSiard22TriggerType visit(ConvertableSiard21TriggerType trigger) {
    return new ConvertableSiard22TriggerType(trigger.getName(), trigger
        ...
        .getTriggerEvent(), 
        safeConvert(trigger.getActionTime(), ActionTimeType::value, ch.admin.bar.siard2.api.generated.ActionTimeType::fromValue));
  }
  ...
  private ConvertableSiard22UniqueKeyType convertPrimaryKey(ch.admin.bar.siard2.api.generated.old21.UniqueKeyType primaryKey) {
