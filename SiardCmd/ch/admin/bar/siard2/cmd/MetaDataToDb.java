...
public class MetaDataToDb extends MetaDataBase {
  ...
  private ArchiveMapping _am = null; public ArchiveMapping getArchiveMapping() {
    return this._am;
  ...
  private void createSchema(MetaSchema ms, SchemaMapping sm) throws SQLException {
    if (!existsSchema(sm.getMappedSchemaName())) {
      ...
      try {
        ...
        LOG.error(
            String.format("Can not create schema '%s' with SQL statement '%s'", new Object[] {
                
                sm.getMappedSchemaName(), sSql
              }), se);
      ...
      if (ma != null) {
        ...
        try {
          ...
          if (msAttr != null) {
            ...
            if (mtAttr != null) {
              bMatches = matchType(mtAttr, smAttr); continue;
            } 
            bMatches = false;
            continue;
          } 
...
/* Location:              C:\Users\lenovo\IdeaProjects\SIARD_KR_2.2\lib\siardcmd.jar!\ch\admin\bar\siard2\cmd\MetaDataToDb.class
