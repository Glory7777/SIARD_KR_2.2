...
public class TbKeepAlivePollingThread extends Thread {
  ...
  public TbKeepAlivePollingThread() {
    ...
    this.keepAliveSetMap = new HashMap<String, HashSet<TbKeepAlive>>();
    start();
  }
...
/* Location:              C:\TmaxData\tibero6\client\lib\jar\tibero6-jdbc.jar!\com\tmax\tibero\jdbc\driver\TbKeepAlivePollingThread.class
