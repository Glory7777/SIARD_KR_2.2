...
public class TbConnection extends TbConnection {
  ...
  public synchronized Statement createStatement(int paramInt1, int paramInt2) throws SQLException {
    ...
    return (Statement)new TbStatement(this, paramInt1, paramInt2, this.preFetchSize);
  }
...
/* Location:              C:\Users\Lenovo\Desktop\tibero\tibero6-jdbc.jar!\com\tmax\tibero\jdbc\driver\TbConnection.class
