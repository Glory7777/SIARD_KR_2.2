...
public interface TbDTFormatParserConstants {
  ...
  public static final String[] tokenImage = new String[] { 
      ...
      "\"TZH\"", "\"TZM\"", "\"TZR\"", "\"W\"", "\"WW\"", "<YEAR__ISO>", "<YEAR__NUMBER>", "\"YEAR\"" };
}


/* Location:              C:\TmaxData\tibero6\client\lib\jar\tibero6-jdbc.jar!\com\tmax\tibero\jdb\\util\TbDTFormatParserConstants.class
