...
public class JA16SJISDecoder implements CharsetDecoder {
  private JA16SJISByteToCharConverter conv = null;
  
  public JA16SJISDecoder() {
    this.conv = new JA16SJISByteToCharConverter();
  }
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\JA16SJISDecoder.class
