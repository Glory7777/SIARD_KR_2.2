...
public class ISO8859P9Decoder implements CharsetDecoder {
  private ISO8859P9ByteToCharConverter conv = null;
  
  public ISO8859P9Decoder() {
    this.conv = new ISO8859P9ByteToCharConverter();
  }
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\ISO8859P9Decoder.class
