...
public class EUCJPEncoder implements CharsetEncoder {
  private EUCJPCharToByteConverter conv = null;
  
  private int maxBytesPerChar = 0;
  
  public EUCJPEncoder() {
    this.conv = new EUCJPCharToByteConverter();
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\EUCJPEncoder.class
