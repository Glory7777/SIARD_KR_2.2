...
public class TbDTFormatter {
  public static String format(TbDTFormat paramTbDTFormat, TbDate paramTbDate, int paramInt) {
    return (paramTbDate == null) ? null : ((paramTbDTFormat == null || paramTbDTFormat.getElements() == null) ? paramTbDate.toString() : formatInternal(paramTbDTFormat, paramTbDate.getYear(), paramTbDate.getMonth(), paramTbDate.getDayOfMonth(), paramTbDate.getHourOfDay(), paramTbDate.getMinutes(), paramTbDate.getSeconds(), 0, 0));
  }
  
  public static String format(TbDTFormat paramTbDTFormat, TbTimestamp paramTbTimestamp, int paramInt) {
    return (paramTbTimestamp == null) ? null : ((paramTbDTFormat == null || paramTbDTFormat.getElements() == null) ? paramTbTimestamp.toString() : formatInternal(paramTbDTFormat, paramTbTimestamp.getYear(), paramTbTimestamp.getMonth(), paramTbTimestamp.getDayOfMonth(), paramTbTimestamp.getHourOfDay(), paramTbTimestamp.getMinutes(), paramTbTimestamp.getSeconds(), paramTbTimestamp.getNanos(), paramInt));
  }
  
  public static String format(TbDTFormat paramTbDTFormat, TbTime paramTbTime, int paramInt) {
    return (paramTbTime == null) ? null : ((paramTbDTFormat == null || paramTbDTFormat.getElements() == null) ? paramTbTime.toString() : formatInternal(paramTbDTFormat, 0, 0, 0, paramTbTime.getHourOfDay(), paramTbTime.getMinutes(), paramTbTime.getSeconds(), paramTbTime.getNanos(), paramInt));
  }
  ...
  private static String formatInternal(TbDTFormat paramTbDTFormat, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8) {
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdb\\util\TbDTFormatter.class
