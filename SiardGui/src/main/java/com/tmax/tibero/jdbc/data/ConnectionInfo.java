...
public class ConnectionInfo implements Cloneable {
    ...
    public static final String NCHAR_LITERAL_REPLACE = "nchar_literal_replace";
    ...
    private boolean nCharLiteralReplace = false;

    private int visitedNodeCount = 0;

    private boolean[] visitedNodes = null;

    private Vector<NodeInfo> nodeList = null;
    ...
    public ConnectionInfo(String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, Properties paramProperties) {
        ...
        if (paramProperties != null) {
            ...
            this.fixedString = paramProperties.getProperty("fixedString", "");
            ...
            preProcessProperties(paramProperties);
    ...
    public Vector<NodeInfo> getNodeList() {
    ...
    public boolean getNCharLiteralReplace() {
        return this.nCharLiteralReplace;
    }

    public void setNcharLiteralReplace(boolean paramBoolean) {
        this.nCharLiteralReplace = paramBoolean;
    }
    ...
    private void preProcessProperties(Properties paramProperties) {
        this.nCharLiteralReplace = preProcessNCharLiteralReplace(paramProperties);
    }

    private boolean preProcessNCharLiteralReplace(Properties paramProperties) {
        String str = System.getProperty("tibero.jdbc.convertNcharLiterals");
        ...
        if (paramProperties != null) {
            String str1 = paramProperties.getProperty("nchar_literal_replace", "false");
    ...
    public void update(Properties paramProperties) {
        ...
        if (paramProperties.getProperty("networkProtocol") != null)
            this.protocol = paramProperties.getProperty("networkProtocol", "tcp");
        if (paramProperties.getProperty("fixedString") != null)
            this.fixedString = paramProperties.getProperty("fixedString", "");
        String str1 = null;
    ...
    public void setFixedString(String paramString) {
        this.fixedString = TbCommon.getEmptyString(paramString, "");
    }
