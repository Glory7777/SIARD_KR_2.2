...
public class JA16SJISTILDEEncoder implements CharsetEncoder {
  private JA16SJISTILDECharToByteConverter conv = null;
  
  private int maxBytesPerChar = 0;
  
  public JA16SJISTILDEEncoder() {
    this.conv = new JA16SJISTILDECharToByteConverter();
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\JA16SJISTILDEEncoder.class
