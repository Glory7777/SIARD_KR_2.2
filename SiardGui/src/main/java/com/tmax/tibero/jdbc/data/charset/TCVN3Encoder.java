...
public class TCVN3Encoder implements CharsetEncoder {
  private TCVN3CharToByteConverter conv = null;
  
  private int maxBytesPerChar = 0;
  
  public TCVN3Encoder() {
    this.conv = new TCVN3CharToByteConverter();
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\TCVN3Encoder.class
