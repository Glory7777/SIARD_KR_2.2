...
import com.tmax.tibero.jdbc.driver.*;
import com.tmax.tibero.jdbc.err.TbError;
import com.tmax.tibero.jdbc.msg.*;
...
public class TbCommType4 implements TbComm, TbClobAccessor, TbBlobAccessor {
    ...
    private int[] batchUpdate(TbPreparedStatementImpl paramTbPreparedStatementImpl, BatchUpdateInfo paramBatchUpdateInfo, int paramInt1, int paramInt2, int paramInt3) throws SQLException {
        ...
        String str = paramTbPreparedStatementImpl.getOriginalSql();
        synchronized (this.stream) {
            try {
                synchronized (this.stream.getWriteStreamBuffer()) {
                    ...
                    if (this.conn.info.getNCharLiteralReplace() && str != null && (str.indexOf("N'") > 0 || str.indexOf("n'") > 0)) {
                        tbStreamDataWriter.writeLenAndSqlWithNPrefixed(str);
                    } else {
                        tbStreamDataWriter.writeLenAndDBEncodedPadString((str == null) ? "" : str);
                    }
            ...
            switch (tbMsg.getMsgType()) {
                ...
                case 286:
                    return executeBatchRsetReply((TbStatement) paramTbPreparedStatementImpl, (TbMsgBatchRsetReply) tbMsg, j, i);
                case 76:
    ...
    private int[] batchUpdateReply(TbMsgBatchUpdateReply paramTbMsgBatchUpdateReply, int paramInt1, int paramInt2) throws SQLException {
        ...
        if ((paramInt2 > 0 && paramInt1 != paramTbMsgBatchUpdateReply.executedCnt) || paramTbMsgBatchUpdateReply.haveError) {
    ...
    public void closeSession() throws SQLException {
        int paramInt = this.conn.getAutoCommit() ? 1 : 0;
        synchronized (this.stream) {
            TbMsgSend.CLOSE_SESS(this.stream, paramInt);
            TbMsg tbMsg = this.stream.readMsg();
            switch (tbMsg.getMsgType()) {
                case 75:
                    justOKReply((TbMsgOkReply) tbMsg);
    ...
    public void dirPathPrepare(TbDirPathStream paramTbDirPathStream) throws SQLException {
        ...
        b = (byte) ((tbDirPathMetaData.getLogFlag()) ? 1 : 0);
        synchronized (this.stream) {
    ...
    public int execute(TbPreparedStatementImpl paramTbPreparedStatementImpl, String paramString, int paramInt) throws SQLException, IOException {
        if (this.conn.getClientInfoIsChanged()) {
            this.conn.setClientInfoIsChanged(false);
            setClientInfo();
        }
        synchronized (this.stream) {
            ...
            while (true) {
                ...
                switch (tbMsg.getMsgType()) {
                    ...
                    case 2:
                        ...
                        if (this.conn.getServerInfo().getProtocolMajorVersion() >= 2 && this.conn.getServerInfo().getProtocolMinorVersion() >= 17) {
    ...
    private int executePsmPrefetchReply(TbCallableStatementImpl paramTbCallableStatementImpl, int paramInt, TbMsgExecutePsmPrefetchReply paramTbMsgExecutePsmPrefetchReply) throws SQLException {
        ...
        for (byte b2 = 0; b2 < b1; b2++) {
            ...
            if (tbResultSet != null && (arrayOfTbOutParam[b2]).colMeta != null && (arrayOfTbOutParam[b2]).dataType == 16) {
                ...
                Vector<byte[]> vector = paramTbCallableStatementImpl.getPivotData();
                if (vector != null)
    ...
    public int executeDirect(TbStatement paramTbStatement, String paramString) throws SQLException {
        ...
        synchronized (this.stream) {
            processExecuteDirect(paramTbStatement, paramString, bool);
            TbMsg tbMsg = this.stream.readMsg();
            while (true) {
                switch (tbMsg.getMsgType()) {
                    case 75:
    ...
    private void processExecuteDirect(TbStatement paramTbStatement, String paramString, int paramInt) throws SQLException {
        synchronized (this.stream.getWriteStreamBuffer()) {
            TbStreamDataWriter tbStreamDataWriter = this.stream.getMsgWriter();
            this.stream.startWritingPacketData();
            ...
            tbStreamDataWriter.writeInt(paramTbStatement.getPreFetchSize(), 4);
            if (this.conn.info.getNCharLiteralReplace() && paramString != null && (paramString.indexOf("N'") > 0 || paramString.indexOf("n'") > 0)) {
                tbStreamDataWriter.writeLenAndSqlWithNPrefixed(paramString);
            } else {
    ...
    private int executeEreply(TbPreparedStatementImpl paramTbPreparedStatementImpl, String paramString, TbMsg paramTbMsg, int paramInt) throws SQLException, IOException {
        SQLException sQLException = getErrorMessage(-90508, paramTbMsg);
        if (sQLException.getErrorCode() == -12018) {
    ...
    private int executeNeedDataReply(TbMsg paramTbMsg, TbPreparedStatementImpl paramTbPreparedStatementImpl, int paramInt) throws SQLException, IOException {
    ...
    private long executePrefetchNoDescReply(TbPreparedStatementImpl paramTbPreparedStatementImpl, TbMsgExecutePrefetchNoDescReply paramTbMsgExecutePrefetchNoDescReply) throws SQLException {
        com.tmax.tibero.jdbc.driver.TbResultSet tbResultSet = processPrefetchedRset((TbStatement) paramTbPreparedStatementImpl, paramTbPreparedStatementImpl.getOutColCnt(), paramTbPreparedStatementImpl.getHiddenColCnt(), paramTbMsgExecutePrefetchNoDescReply.csrId, paramTbPreparedStatementImpl.getColMetaArray(), paramTbMsgExecutePrefetchNoDescReply.rowChunkSize, paramTbMsgExecutePrefetchNoDescReply.rowCnt, paramTbMsgExecutePrefetchNoDescReply.isFetchCompleted, paramTbMsgExecutePrefetchNoDescReply.getTsn());
    ...
    private long executeRsetNoDescReply(TbPreparedStatementImpl paramTbPreparedStatementImpl, TbMsgExecuteRsetNoDescReply paramTbMsgExecuteRsetNoDescReply) throws SQLException {
        com.tmax.tibero.jdbc.driver.TbResultSet tbResultSet = this.typeConverter.toResultSet(paramTbPreparedStatementImpl.getOutColCnt(), paramTbPreparedStatementImpl.getHiddenColCnt(), paramTbMsgExecuteRsetNoDescReply.csrId, paramTbPreparedStatementImpl.getColMetaArray(), (TbStatement) paramTbPreparedStatementImpl, null);
    ...
    private long executeRsetReply(TbStatement paramTbStatement, TbMsgExecuteRsetReply paramTbMsgExecuteRsetReply) throws SQLException {
        com.tmax.tibero.jdbc.driver.TbResultSet tbResultSet = this.typeConverter.toResultSet(paramTbMsgExecuteRsetReply.colCnt, paramTbMsgExecuteRsetReply.hiddenColCnt, paramTbMsgExecuteRsetReply.csrId, paramTbMsgExecuteRsetReply.colMeta, paramTbStatement, null);
        tbResultSet.setTsn(paramTbMsgExecuteRsetReply.getTsn());
        paramTbStatement.setResultSet(tbResultSet);
        return paramTbMsgExecuteRsetReply.affectedCnt;
    }

    private int[] executeBatchRsetReply(TbStatement paramTbStatement, TbMsgBatchRsetReply paramTbMsgBatchRsetReply, int paramInt1, int paramInt2) throws SQLException {
        com.tmax.tibero.jdbc.driver.TbResultSet tbResultSet = this.typeConverter.toResultSet(paramTbMsgBatchRsetReply.colCnt, paramTbMsgBatchRsetReply.hiddenColCnt, paramTbMsgBatchRsetReply.csrId, paramTbMsgBatchRsetReply.colMeta, paramTbStatement, null);
        tbResultSet.setTsn(paramTbMsgBatchRsetReply.getTsn());
        paramTbStatement.setResultSet(tbResultSet);
        int[] arrayOfInt = new int[paramTbMsgBatchRsetReply.executedCnt];
        if (paramTbMsgBatchRsetReply.affectedCnt == null) {
            for (byte b = 0; b < paramTbMsgBatchRsetReply.executedCnt; b++)
                arrayOfInt[b] = 1;
        } else {
            for (byte b = 0; b < paramTbMsgBatchRsetReply.executedCnt; b++)
                arrayOfInt[b] = (paramTbMsgBatchRsetReply.affectedCnt[b]).cnt;
        }
        if (paramInt2 > 0 && paramInt1 != paramTbMsgBatchRsetReply.executedCnt) {
            SQLException sQLException = paramTbMsgBatchRsetReply.getException(-90515);
            throw new BatchUpdateException(sQLException.getMessage(), sQLException.getSQLState(), sQLException.getErrorCode(), arrayOfInt, sQLException);
        }
        return arrayOfInt;
    }
    ...
    private void executeSessInfoReply(TbMsgSessInfoReply paramTbMsgSessInfoReply) {
        ...
        this.conn.setNLSTime((paramTbMsgSessInfoReply.nlsData[1]).nlsParamVal);
        this.conn.setNLSTimestamp((paramTbMsgSessInfoReply.nlsData[2]).nlsParamVal);
        this.conn.setNLSTimestampTZ((paramTbMsgSessInfoReply.nlsData[6]).nlsParamVal);
    ...
    private com.tmax.tibero.jdbc.driver.TbResultSet doDescribeCSRPrefetch(TbStatement paramTbStatement, TbMsgExecutePrefetchReply paramTbMsgExecutePrefetchReply) throws SQLException {
    ...
    public Properties getClientInfo() throws SQLException {
        ...
        String str2 = null;
        for (String str1 : this.conn.clientInfoMap.stringPropertyNames()) {
            str2 = this.conn.clientInfoMap.getProperty(str1);
    ...
    public String getClientInfo(String paramString) throws SQLException {
        return this.conn.clientInfoMap.getProperty(paramString);
    }
    ...
    private void logonAuthRequest(boolean paramBoolean) throws SQLException {
        ...
        if ((str2 != null && (dataTypeConverter.getDBEncodedBytes(str2)).length > 63) || (str1 != null && (dataTypeConverter.getDBEncodedBytes(str1)).length > 128))
            throw TbError.newSQLException(-90502);
        if (this.rsa != null && this.conn.getSessKey() != null)
            try {
                DataTypeConverter dataTypeConverter1 = this.conn.getTypeConverter();
                ...
                byte[] arrayOfByte2 = this.rsa.doFinal(dataTypeConverter1.getDBEncodedBytes(str2));
                str2 = DataTypeConverter.tbBase64Encode(arrayOfByte2);
                if (str8 != null) {
                    arrayOfByte2 = this.rsa.doFinal(dataTypeConverter1.getDBEncodedBytes(str8));
        ...
        arrayOfTbNlsParam[8].set(8, null);
        arrayOfTbNlsParam[9].set(9, null);
        arrayOfTbNlsParam[10].set(10, null);
        arrayOfTbNlsParam[11].set(11, null);
        arrayOfTbNlsParam[12].set(12, CharsetMetaData.getNLSTerritory(Locale.getDefault()));
        arrayOfTbNlsParam[13].set(13, CharsetMetaData.getNLSLanguage(Locale.getDefault()));
        TbMsgSend.AUTH_REQ_WITH_VER(this.stream, 2, 17, i, str1, str3, str2, arrayOfTbClntInfoParam.length, arrayOfTbClntInfoParam, arrayOfTbNlsParam.length, arrayOfTbNlsParam, 1);
    }
    ...
    public int prepareExecute(TbPreparedStatementImpl paramTbPreparedStatementImpl, String paramString, int paramInt) throws SQLException, IOException {
    ...
    private void processExecute(TbPreparedStatementImpl paramTbPreparedStatementImpl, String paramString, int paramInt, boolean paramBoolean) throws SQLException {
        synchronized (this.stream.getWriteStreamBuffer()) {
            ...
            } else if (this.conn.info.getNCharLiteralReplace() && paramString != null && (paramString.indexOf("N'") > 0 || paramString.indexOf("n'") > 0)) {
                tbStreamDataWriter.writeLenAndSqlWithNPrefixed(paramString);
            } else {
                tbStreamDataWriter.writeLenAndDBEncodedPadString((paramString == null) ? "" : paramString);
            }
    ...
    private com.tmax.tibero.jdbc.driver.TbResultSet processPrefetchedRset(TbStatement paramTbStatement, int paramInt1, int paramInt2, int paramInt3, TbColumnDesc[] paramArrayOfTbColumnDesc, int paramInt4, int paramInt5, int paramInt6, long paramLong) throws SQLException {
        byte[] arrayOfByte = new byte[paramInt4];
        this.stream.readChunkData(arrayOfByte, paramInt4);
        com.tmax.tibero.jdbc.driver.TbResultSet tbResultSet = this.typeConverter.toResultSet(paramInt1, paramInt2, paramInt3, paramArrayOfTbColumnDesc, paramTbStatement, arrayOfByte);
    ...
    public void setClientInfo(String paramString1, String paramString2) throws SQLClientInfoException {
        if (TbConnection.CLIENT_INFO_SET.contains(paramString1)) {
            if (paramString2 == null)
                throw new SQLClientInfoException("Client info setup has failed. Unsupported client info value.", "Unsupported client info value.", null);
            this.conn.clientInfoMap.setProperty(paramString1, paramString2);
            this.conn.clientInfoChangedMap.put(paramString1, Boolean.valueOf(true));
            this.conn.setClientInfoIsChanged(true);
        } else {
            HashMap<String, ClientInfoStatus> hashMap = new HashMap<>();
            hashMap.put(paramString1, ClientInfoStatus.REASON_UNKNOWN_PROPERTY);
            throw new SQLClientInfoException("Client info setup has failed. Unsupported client info key.", "Unsupported client info key.", hashMap);
        }
    }

    public void setClientInfo(Properties paramProperties) throws SQLClientInfoException {
        this.conn.clientInfoMap.clear();
        this.conn.clientInfoChangedMap.clear();
        Set<String> set = paramProperties.stringPropertyNames();
        HashMap<String, ClientInfoStatus> hashMap = new HashMap<>();
        for (String str1 : set) {
            String str2 = paramProperties.getProperty(str1);
            if (TbConnection.CLIENT_INFO_SET.contains(str1)) {
                this.conn.clientInfoMap.setProperty(str1, str2);
                this.conn.clientInfoChangedMap.put(str1, Boolean.valueOf(true));
                this.conn.setClientInfoIsChanged(true);
                continue;
            }
            hashMap.put(str1, ClientInfoStatus.REASON_UNKNOWN_PROPERTY);
        }
        if (!hashMap.isEmpty())
            throw new SQLClientInfoException("Client info setup has failed. Unsupported client info key.", "Unsupported client info key.", hashMap);
    }

    private void setClientInfo() throws SQLException {
        HashMap<String, ClientInfoStatus> hashMap = new HashMap<>();
        HashMap<String, Boolean> hashMap1 = this.conn.clientInfoChangedMap;
        String str = TbDatabaseMetaQuery.getSetClientInfoQuery(hashMap1);
        try {
            PreparedStatement preparedStatement = this.conn.prepareStatement(str);
            byte b = 1;
            if (hashMap1.get("ClientID") != null && ((Boolean) hashMap1.get("ClientID")).booleanValue()) {
                preparedStatement.setString(b++, this.conn.clientInfoMap.getProperty("ClientID"));
                hashMap1.put("ClientID", Boolean.valueOf(false));
            }
            if (hashMap1.get("Module") != null && ((Boolean) hashMap1.get("Module")).booleanValue()) {
                preparedStatement.setString(b++, this.conn.clientInfoMap.getProperty("Module"));
                hashMap1.put("Module", Boolean.valueOf(false));
            }
            if (hashMap1.get("Action") != null && ((Boolean) hashMap1.get("Action")).booleanValue()) {
                preparedStatement.setString(b++, this.conn.clientInfoMap.getProperty("Action"));
                hashMap1.put("Action", Boolean.valueOf(false));
            }
            if (hashMap1.get("ClientInfo") != null && ((Boolean) hashMap1.get("ClientInfo")).booleanValue()) {
                preparedStatement.setString(b++, this.conn.clientInfoMap.getProperty("ClientInfo"));
                hashMap1.put("ClientInfo", Boolean.valueOf(false));
            }
            preparedStatement.execute();
        } catch (SQLException sQLException) {
            hashMap.put("ClientInfo", ClientInfoStatus.REASON_UNKNOWN);
            hashMap.put("Module", ClientInfoStatus.REASON_UNKNOWN);
            hashMap.put("Action", ClientInfoStatus.REASON_UNKNOWN);
            hashMap.put("ClientID", ClientInfoStatus.REASON_UNKNOWN);
    ...
    public long prepareExecuteLarge(TbPreparedStatementImpl paramTbPreparedStatementImpl, String paramString, int paramInt) throws SQLException, IOException {
        if (paramTbPreparedStatementImpl.getPPID() != null)
            return execute(paramTbPreparedStatementImpl, paramString, paramInt);
        synchronized (this.stream) {
            processExecute(paramTbPreparedStatementImpl, paramString, paramInt, false);
            ...
            while (true) {
                ...
                switch (tbMsg.getMsgType()) {
                    case 75:
                        justOKReply((TbMsgOkReply) tbMsg);
                        return TbSQLTypeScanner.isPSMStmt(paramTbPreparedStatementImpl.getSqlType()) ? 1L : 0L;
                    case 2:
                        executeSessInfoReply((TbMsgSessInfoReply) tbMsg);
                        if (this.conn.getServerInfo().getProtocolMajorVersion() >= 2 && this.conn.getServerInfo().getProtocolMinorVersion() >= 17) {
                            tbMsg = this.stream.readMsg();
                    ...
                    case 13:
                        tbMsgExecuteCountReply = (TbMsgExecuteCountReply) tbMsg;
                        paramTbPreparedStatementImpl.setPPID(tbMsgExecuteCountReply.ppid);
                        return executeCountReply((TbStatement) paramTbPreparedStatementImpl, tbMsgExecuteCountReply);
                    case 11:
                        tbMsgExecutePrefetchReply = (TbMsgExecutePrefetchReply) tbMsg;
                        paramTbPreparedStatementImpl.setPPID(tbMsgExecutePrefetchReply.ppid);
                        paramTbPreparedStatementImpl.buildColMetaArray(tbMsgExecutePrefetchReply.colCnt, tbMsgExecutePrefetchReply.hiddenColCnt, tbMsgExecutePrefetchReply.colMeta);
                        return executePrefetchReply((TbStatement) paramTbPreparedStatementImpl, tbMsgExecutePrefetchReply);
                    case 8:
                        tbMsgExecuteRsetReply = (TbMsgExecuteRsetReply) tbMsg;
                        paramTbPreparedStatementImpl.setPPID(tbMsgExecuteRsetReply.ppid);
                        paramTbPreparedStatementImpl.buildColMetaArray(tbMsgExecuteRsetReply.colCnt, tbMsgExecuteRsetReply.hiddenColCnt, tbMsgExecuteRsetReply.colMeta);
                        return executeRsetReply((TbStatement) paramTbPreparedStatementImpl, tbMsgExecuteRsetReply);
                    case 16:
                        return executeNeedDataReply(tbMsg, paramTbPreparedStatementImpl, paramInt);
                    case 15:
                        tbMsgExecutePsmReply = (TbMsgExecutePsmReply) tbMsg;
    ...
    public long executeLargeDirect(TbStatement paramTbStatement, String paramString) throws SQLException {
        int bool = this.conn.getAutoCommit() ? 1 : 0;
        synchronized (this.stream) {
            processExecuteDirect(paramTbStatement, paramString, bool);
            TbMsg tbMsg = this.stream.readMsg();
            while (true) {
                switch (tbMsg.getMsgType()) {
                    case 75:
                        justOKReply((TbMsgOkReply) tbMsg);
                        return TbSQLTypeScanner.isPSMStmt(paramTbStatement.getSqlType()) ? 1L : 0L;
                    case 2:
                        executeSessInfoReply((TbMsgSessInfoReply) tbMsg);
                        if (this.conn.getServerInfo().getProtocolMajorVersion() >= 2 && this.conn.getServerInfo().getProtocolMinorVersion() >= 17) {
                            tbMsg = this.stream.readMsg();
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\comm\TbCommType4.class
