...
public class TbDTFormatParser implements TbDTFormatParserConstants {
    ...
    private final void delimiter(TbDTFormat paramTbDTFormat) throws ParseException {
        ...
        switch ((this.jj_ntk == -1) ? jj_ntk() : this.jj_ntk) {
            ...
            case 58:
                jj_consume_token(58);
                tbDTFormatElement = TbDTFormatElement.newInstance(58, this.token.toString());
                paramTbDTFormat.addElement(tbDTFormatElement);
                return;
        }
    ...
    private final void field(TbDTFormat paramTbDTFormat) throws ParseException {
        ...
        switch (this.token.kind) {
            ...
            case 33:
                ...
                prec = (str.length() == 2) ? 0 : Integer.parseInt(str.substring(2));
                element = TbDTFormatElement.newInstance(this.token.kind, this.token.toString(), prec);
                paramTbDTFormat.addElement(element);
                return;
            case 42:
            case 55:
            case 56:
                str = this.token.toString();
                element = TbDTFormatElement.newInstance(this.token.kind, str, str.length());
                paramTbDTFormat.addElement(element);
                return;
        }
    ...
    private static void jj_la1_1() {
        jj_la1_1 = new int[]{134217727, 134217727, 67108864, 67108863};
    }
    ...
    public ParseException generateParseException() {
        ...
        boolean[] arrayOfBoolean = new boolean[59];
        int b1;
        for (b1 = 0; b1 < 59; b1++)
