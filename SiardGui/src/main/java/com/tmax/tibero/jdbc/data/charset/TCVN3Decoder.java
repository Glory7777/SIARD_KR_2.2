...
public class TCVN3Decoder implements CharsetDecoder {
  private TCVN3ByteToCharConverter conv = null;
  
  public TCVN3Decoder() {
    this.conv = new TCVN3ByteToCharConverter();
  }
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\TCVN3Decoder.class
