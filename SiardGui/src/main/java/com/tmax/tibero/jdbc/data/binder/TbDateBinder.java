...
public class TbDateBinder extends Binder {
  public void bind(TbConnection paramTbConnection, ParamContainer paramParamContainer, TbStreamDataWriter paramTbStreamDataWriter, int paramInt1, int paramInt2, int paramInt3) throws SQLException {
    ...
    TbDate tbDate = paramParamContainer.getParamTbDate(paramInt1, paramInt2);
    ...
    int j = dataTypeConverter.fromTbDate(arrayOfByte, i + 1, tbDate);
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\binder\TbDateBinder.class
