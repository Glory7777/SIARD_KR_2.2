...
public class TbLogicalConnection extends TbConnection {
    ...
    public TbLogicalConnection(TbConnectionEventHandler paramTbConnectionEventHandler, com.tmax.tibero.jdbc.driver.TbConnection paramTbConnection, boolean paramBoolean) throws SQLException {
    ...
    public void setSchema(String paramString) throws SQLException {
        this.physicalConn.setSchema(paramString);
    }
    ...
    public void abort(Executor paramExecutor) throws SQLException {
        this.physicalConn.abort(paramExecutor);
    }

    public void setNetworkTimeout(Executor paramExecutor, int paramInt) throws SQLException {
        this.physicalConn.setNetworkTimeout(paramExecutor, paramInt);
    }
