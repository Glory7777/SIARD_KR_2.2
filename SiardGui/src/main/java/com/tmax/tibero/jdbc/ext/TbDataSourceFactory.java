...
public class TbDataSourceFactory implements ObjectFactory {
  ...
  public Object getObjectInstance(Object paramObject, Name paramName, Context paramContext, Hashtable paramHashtable) throws Exception {
    ...
    if ((stringRefAddr = (StringRefAddr)reference.get("fixedString")) != null)
      properties.setProperty("fixedString", (String)stringRefAddr.getContent()); 
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\ext\TbDataSourceFactory.class
