...
public class MS932Decoder implements CharsetDecoder {
  private MS932ByteToCharConverter conv = null;
  
  public MS932Decoder() {
    this.conv = new MS932ByteToCharConverter();
  }
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\MS932Decoder.class
