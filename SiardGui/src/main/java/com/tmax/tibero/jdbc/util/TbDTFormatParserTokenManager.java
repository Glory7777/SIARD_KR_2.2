...
public class TbDTFormatParserTokenManager implements TbDTFormatParserConstants {
  ...
  public static final String[] jjstrLiteralImages = new String[] { 
      ...
      "TZH", "TZM", "TZR", "W", "WW", null, null, "YEAR", null };
  ...
  private final int jjMoveNfa_0(int paramInt1, int paramInt2) {
    ...
    while (true) {
      ...
      if (this.curChar < '@') {
        ...
        do {
          switch (this.jjstateSet[--j]) {
            case 6:
              if ((0xF0000FFE00000000L & l) != 0L) {
                if (k > 58)
                  k = 58; 
              } else if ((0xC00F00100000000L & l) != 0L) {
                if (k > 15)
                  k = 15; 
                jjCheckNAdd(0);
              } 
            ...
            case 9:
              ...
              break;
            case 25:
              if ((0xF0000FFE00000000L & l) != 0L && k > 58)
                k = 58; 
              break;
            case 28:
        ...
        do {
          switch (this.jjstateSet[--j]) {
            ...
            case 24:
              ...
              break;
            case 25:
              if ((0x78000001F8000001L & l) != 0L && k > 58)
                k = 58; 
              break;
            case 26:
              if (this.curChar == 'B')
      ...
      paramInt2++;
      if ((j = this.jjnewStateCnt) == (i = 42 - (this.jjnewStateCnt = i)))
        return paramInt2; 
      try {
        this.curChar = this.input_stream.readChar();
      } catch (IOException iOException) {
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdb\\util\TbDTFormatParserTokenManager.class
