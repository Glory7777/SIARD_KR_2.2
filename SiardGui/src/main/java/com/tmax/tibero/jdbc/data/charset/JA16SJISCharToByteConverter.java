...
public class JA16SJISCharToByteConverter extends JA16SJISDBCharToByteConverter {
  ...
  protected int convSingleByte(char paramChar) {
    return ((paramChar & 0xFF80) == 0) ? 1 : ((this.JIS0201cb.getNative(paramChar) == 0) ? 0 : 1);
  }
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\JA16SJISCharToByteConverter.class
