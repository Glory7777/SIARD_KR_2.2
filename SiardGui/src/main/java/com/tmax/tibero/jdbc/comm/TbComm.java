...
public interface TbComm {
    ...
    int execute(TbPreparedStatementImpl paramTbPreparedStatementImpl, String paramString, int paramInt) throws SQLException, IOException;
    ...
    int prepareExecute(TbPreparedStatementImpl paramTbPreparedStatementImpl, String paramString, int paramInt) throws SQLException, IOException;
    ...
    long prepareExecuteLarge(TbPreparedStatementImpl paramTbPreparedStatementImpl, String paramString, int paramInt) throws SQLException, IOException;

    long executeLargeDirect(TbStatement paramTbStatement, String paramString) throws SQLException;
}