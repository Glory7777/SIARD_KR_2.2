...
public class ColumnFileDownloadPresenter {
    ...
    public void init(
        ...
        this.treeView.setCellFactory(new ColumnCheckBoxTreeCellFactory());
        String size =  String.valueOf(rootTreeItem.getValue().getSize());
        this.totalSizeLabel.setText(size);
    ...
    public static LoadedView<ColumnFileDownloadPresenter> load(
        ...
        val loaded = FXMLLoadHelper.<ColumnFileDownloadPresenter>load("fxml/column-file-download.fxml");
