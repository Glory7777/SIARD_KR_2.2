    ...
    try {
      ...
      for (byte b = 0; b < udtMeta.getHierarchyCnt(); b++) {
        ...
        for (byte b1 = 0; b1 < arrayOfBigDecimal.length; b1++) {
          ...
          if (b1 == 1 && udtInfo.getOid().equals("0000000000000000000000000000000A"))
            arrayOfInt[b1] = 4; 
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\TbStructDescriptor.class
