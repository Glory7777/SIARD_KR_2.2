...
public class DBConst {
  ...
  public static final int CS_DISCONNECT = -2147483648;
  ...
  public static final int ERROR_STMT_CANCEL = -12040;
  ...
  public static final int LOBLOC_FLAG2_REMOTE = 2;
  
  public static final int LOBLOC_FLAG2_XML = 8;
  
  public static final int NUMBER_MAX_SIZE = 22;
  
  public static final int PRODUCT_MAJOR = 6;
  ...
  public static final int RPCOL_3BYTE = 254;
  
  public static final int RPCOL_LARGE = 254;
  
  public static final int RPCOL_5BYTE = 253;
  ...
  public static final int TBMSG_AUTH_REQ_TAS = 284;
  
  public static final int TBMSG_AUTH_REQ_WITH_VER = 137;
  
  public static final int TBMSG_AUTH_REQ_WITH_VER_SVC_NAME = 348;
  
  public static final int TBMSG_BATCH_RSET_REPLY = 286;
  ...
  public static final int TBMSG_CM_CLS_JOIN = 292;
  
  public static final int TBMSG_CM_CLS_JOIN_REPLY = 293;
  
  public static final int TBMSG_CM_CTL2 = 346;
  
  public static final int TBMSG_CM_CTL = 288;
  
  public static final int TBMSG_CM_CTL_REDIRECT = 289;
  
  public static final int TBMSG_CM_CTL_REDIRECT_ALL_NODE = 323;
  
  public static final int TBMSG_CM_CTL_REMOTE = 313;
  
  public static final int TBMSG_CM_CTL_REPLY = 290;
  
  public static final int TBMSG_CM_GREETING = 310;
  
  public static final int TBMSG_CM_GREETING_REPLY = 311;
  
  public static final int TBMSG_CM_GUARD_PID = 300;
  
  public static final int TBMSG_CM_GUARD_VIP = 301;
  
  public static final int TBMSG_CM_GUARD_VIP_IPV6 = 369;
  
  public static final int TBMSG_CM_INST_INFO = 315;
  
  public static final int TBMSG_CM_INST_INTR = 316;
  
  public static final int TBMSG_CM_INST_SETUP_STB_CF = 342;
  
  public static final int TBMSG_CM_INST_TSC_INFO = 339;
  
  public static final int TBMSG_CM_INTR = 296;
  
  public static final int TBMSG_CM_MST_ELECT = 287;
  
  public static final int TBMSG_CM_NET_HB = 294;
  
  public static final int TBMSG_CM_NODE_SYNC = 312;
  
  public static final int TBMSG_CM_NOTIFY = 298;
  
  public static final int TBMSG_CM_OBS_AUTODIE_SET = 335;
  
  public static final int TBMSG_CM_OBS_DEL_CLSID = 330;
  
  public static final int TBMSG_CM_OBS_HEADER = 324;
  
  public static final int TBMSG_CM_OBS_INDIV_SWOV = 341;
  
  public static final int TBMSG_CM_OBS_JOIN_PERM = 325;
  
  public static final int TBMSG_CM_OBS_MSTCAND = 328;
  
  public static final int TBMSG_CM_OBS_NODE_INFO = 329;
  
  public static final int TBMSG_CM_OBS_RECO_BOOT = 340;
  
  public static final int TBMSG_CM_OBS_SCLSID = 338;
  
  public static final int TBMSG_CM_RES_SHARE = 291;
  
  public static final int TBMSG_CM_SVC_INFO = 295;
  
  public static final int TBMSG_CM_SVC_INST_INFO = 297;
  
  public static final int TBMSG_CM_TIME = 345;
  
  public static final int TBMSG_CM_VIP_INFO = 299;
  
  public static final int TBMSG_CM_VIP_LOST = 317;
  ...
  public static final int TBMSG_EXECUTE_PIVOT = 314;
  ...
  public static final int TBMSG_HL_ACTIVE = 366;
  
  public static final int TBMSG_HL_ACTIVE_REPLY = 367;
  
  public static final int TBMSG_HL_ADAPTIVE_LOAD_DATA = 376;
  
  public static final int TBMSG_HL_ADMIN_CONNECT = 365;
  
  public static final int TBMSG_HL_ADMIN_TO_HYPER_DATA = 352;
  
  public static final int TBMSG_HL_ADMIN_UPDATE_STATUS = 368;
  
  public static final int TBMSG_HL_CREATE_BUFFER_POOL = 356;
  
  public static final int TBMSG_HL_DB_CONNECT_REPLY = 373;
  
  public static final int TBMSG_HL_DB_CONNECT_REQUEST = 372;
  
  public static final int TBMSG_HL_DOWN = 351;
  
  public static final int TBMSG_HL_FINISH_ADAPTIVE_LOAD = 377;
  
  public static final int TBMSG_HL_FINISH_LOAD = 363;
  
  public static final int TBMSG_HL_FINISH_LOAD_REPLY = 364;
  
  public static final int TBMSG_HL_HYPER_DATA_TO_ADMIN = 353;
  
  public static final int TBMSG_HL_INITIATE_ADAPTIVE_LOAD = 375;
  
  public static final int TBMSG_HL_INITIATE_LOAD = 357;
  
  public static final int TBMSG_HL_INITIATE_LOAD_REPLY = 358;
  
  public static final int TBMSG_HL_LOAD_DATA = 359;
  
  public static final int TBMSG_HL_LOAD_DATA_REPLY = 361;
  
  public static final int TBMSG_HL_LOAD_DATA_WITH_LOB = 360;
  
  public static final int TBMSG_HL_LOG_INFO_ARRAY = 362;
  
  public static final int TBMSG_HL_SET_BUFFER_COUNT = 355;
  
  public static final int TBMSG_HL_TABLE_EXTRACT_REQUEST = 374;
  
  public static final int TBMSG_HL_USER_CUSTOM = 354;
  
  public static final int TBMSG_HORDE = 210;
  
  public static final int TBMSG_HSSVR_GREETING = 378;
  
  public static final int TBMSG_HSSVR_GREETING_REPLY = 379;
  ...
  public static final int TBMSG_OBS_AUTODIE_SET = 334;
  
  public static final int TBMSG_OBS_GREETING = 326;
  
  public static final int TBMSG_OBS_GREETING_REPLY = 327;
  
  public static final int TBMSG_OBS_HB = 331;
  
  public static final int TBMSG_OBS_NODE_INFO = 332;
  
  public static final int TBMSG_OBS_SCLSID = 337;
  
  public static final int TBMSG_OBS_SHUTDOWN = 336;
  
  public static final int TBMSG_OBS_SWITCHOVER = 333;
  ...
  public static final int TBMSG_PREPARE_BATCHUPDATE2 = 285;
  ...
  public static final int TBMSG_REQUEST_SESSKEY = 282;
  ...
  public static final int TBMSG_SESSKEY_REPLY = 283;
  ...
  public static final int TBMSG_SVR_AUTH_REQ_WITH_RTH_ID_SVC_NAME = 350;
  
  public static final int TBMSG_SVR_AUTH_REQ_WITH_VER = 138;
  
  public static final int TBMSG_SVR_AUTH_REQ_WITH_VER_SVC_NAME = 349;
  
  public static final int TBMSG_SVR_BLOCK_SYNC = 343;
  ...
  public static final int TBMSG_SVR_LOG_START_NEW = 344;
  ...
  public static final int TBMSG_TBAS_EM_IO_DONE = 322;
  
  public static final int TBMSG_TBAS_EM_OFFSET = 266;
  
  public static final int TBMSG_TBAS_EM_OFFSET_REPLY = 267;
  
  public static final int TBMSG_TBAS_FILE_INFO = 308;
  
  public static final int TBMSG_TBAS_FILE_INFO_REPLY = 309;
  
  public static final int TBMSG_TBAS_LIST_DS = 306;
  
  public static final int TBMSG_TBAS_LIST_DS_REPLY = 307;
  
  public static final int TBMSG_TBAS_OPEN2 = 319;
  
  public static final int TBMSG_TBAS_OPEN = 264;
  
  public static final int TBMSG_TBAS_OPEN_REPLY2 = 320;
  
  public static final int TBMSG_TBAS_OPEN_REPLY3 = 321;
  
  public static final int TBMSG_TBAS_OPEN_REPLY = 265;
  
  public static final int TBMSG_TBAS_READDIR = 304;
  
  public static final int TBMSG_TBAS_READDIR_REPLY = 305;
  
  public static final int TBMSG_TBAS_RESIZE = 303;
  
  public static final int TBMSG_TBAS_UNLINK = 302;
  
  public static final int TBMSG_TBAS_VERIFY = 370;
  
  public static final int TBMSG_TBAS_VERIFY_REPLY = 371;
  
  public static final int TBMSG_TBCM_CLUSTER_HEARTBEAT = 279;
  
  public static final int TBMSG_TBCM_CLUSTER_MEMBER = 278;
  ...
  public static final int TBMSG_TBCM_SVR_VIP_ACTION = 281;
  
  public static final int TBMSG_TBCM_SVR_VIP_INFO = 280;
  ...
  public static final int TBMSG_TSAM_READ_REQUEST_NEW = 347;
  ...
  public static final int TBMSG_XA_START_TO_OWNER = 318;
  
  public static final String TB_BRANCH_NAME = " ";
  ...
  public static final int TB_LONG_SIZE_MAX = 2147483647;
  ...
  public static final int TB_MAXLEN_PASSWORD = 63;
  
  public static final int TB_MAXLEN_USERNAME = 128;
  
  public static final int TB_NLS_PARAM_CURRENCY = 10;
  ...
  public static final int TB_NLS_PARAM_ISO_CURRENCY = 11;
  
  public static final int TB_NLS_PARAM_LANGUAGE = 13;
  
  public static final int TB_NLS_PARAM_MAX = 14;
  
  public static final int TB_NLS_PARAM_NUMERIC_CHARACTERS = 9;
  ...
  public static final int TB_NLS_PARAM_TERRITORY = 12;
  ...
  public static final int TB_RAW_MAX_SIZE = 2000;
  ...
  public static final byte TB_TYPE_INVALID = 34;
  ...
  public static final byte TB_TYPE_OBJECT = 32;
  ...
  public static final byte TB_TYPE_REF = 33;
  ...
  public static final int TB_VARCHAR2_SIZE_MAX = 65532;
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\dbconst\DBConst.class
