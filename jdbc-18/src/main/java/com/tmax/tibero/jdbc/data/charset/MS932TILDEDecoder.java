...
public class MS932TILDEDecoder implements CharsetDecoder {
  private MS932TILDEByteToCharConverter conv = null;
  
  public MS932TILDEDecoder() {
    this.conv = new MS932TILDEByteToCharConverter();
  }
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\MS932TILDEDecoder.class
