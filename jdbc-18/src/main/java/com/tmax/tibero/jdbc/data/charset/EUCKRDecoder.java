...
public class EUCKRDecoder implements CharsetDecoder {
  private EUCKRByteToCharConverter conv = null;
  
  public EUCKRDecoder() {
    this.conv = new EUCKRByteToCharConverter();
  }
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\EUCKRDecoder.class
