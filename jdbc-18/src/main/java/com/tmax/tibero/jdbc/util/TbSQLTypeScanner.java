    ...
    public synchronized int getSQLType(String paramString) {
        ...
        if (str.equals(arrayOfString1[0])) {
            ...
            while (matchFlag > 0) {
                ...
                int k;
                for (k = nextStartIdx; k < arrayOfString1.length; k++) {
                ...
                if ((matchFlag & 0x1) > 0 && (matchFlag & 0x20) > 0 && (matchFlag & 0x40) > 0)
                    return 136;
        ...
        if (str.startsWith(arrayOfString2[0])) {
            ...
            while (matchFlag > 0) {
                ...
                int m;
                for (m = nextStartIdx; m < arrayOfString2.length; m++) {
                ...
                if ((matchFlag & 0x1) > 0 && (matchFlag & 0x8) > 0)
                    return 66;
