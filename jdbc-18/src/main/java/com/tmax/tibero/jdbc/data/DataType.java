...
public class DataType {
  ...
  public static int getSqlType(Object paramObject) throws SQLException {
    ...
    if (paramObject instanceof java.sql.Timestamp || paramObject instanceof TbTimestamp)
      return 93; 
    if (paramObject instanceof java.time.LocalDate)
      return 91; 
    if (paramObject instanceof java.time.LocalDateTime)
      return 93; 
    if (paramObject instanceof java.time.LocalTime)
      return 92; 
    if (paramObject instanceof java.time.OffsetTime)
      return 2013; 
    if (paramObject instanceof java.time.OffsetDateTime)
      return 2014; 
    ...
    if (paramObject instanceof java.sql.Array)
      return 2003; 
    if (paramObject instanceof java.sql.Struct || paramObject instanceof java.sql.SQLData || paramObject instanceof com.tmax.tibero.jdbc.TbAnydata)
      return 2002; 
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\DataType.class
