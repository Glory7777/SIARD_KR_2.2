...
public class MS932TILDEEncoder implements CharsetEncoder {
  private MS932TILDECharToByteConverter conv = null;
  
  private int maxBytesPerChar = 0;
  
  public MS932TILDEEncoder() {
    this.conv = new MS932TILDECharToByteConverter();
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\MS932TILDEEncoder.class
