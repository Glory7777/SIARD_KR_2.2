...
public class TbSQLOutput implements SQLOutput {
  ...
  public void writeObject(Object paramObject, SQLType paramSQLType) throws SQLException {
    this.attributes[this.index++] = paramObject;
  }
}


/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\TbSQLOutput.class
