...
public class MS949Decoder implements CharsetDecoder {
  private MS949ByteToCharConverter conv = null;
  
  public MS949Decoder() {
    this.conv = new MS949ByteToCharConverter();
  }
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\MS949Decoder.class
