...
public class DPLDateBinder extends DPLBinder {
  public void bind(TbConnection paramTbConnection, TbDirPathStream paramTbDirPathStream, TbStreamDataWriter paramTbStreamDataWriter, int paramInt1, int paramInt2) throws SQLException {
    ...
    Date date = paramTbDirPathStream.getParamDate(paramInt1);
    ...
    int j = dataTypeConverter.castFromDate(arrayOfByte, k, date, i);
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\dpl\binder\DPLDateBinder.class
