...
public class TbPreparedStatementImpl extends TbStatement implements PreparedStatement, ParamContainer {
    ...
    private int executeCompleteSQL(String paramString) throws SQLException, IOException {
    ...
    private void growBatchArray(int paramInt1, int paramInt2) {
        ...
        if (this.paramStruct != null) {
            Struct[][] arrayOfStruct = this.paramStruct;
            this.paramStruct = new Struct[j][i];
            for (byte b = 0; b < this.allocatedBatchRowCount; b++)
                System.arraycopy(arrayOfStruct[b], 0, this.paramStruct[b], 0, this.bindParamCnt);
        }
        if (this.paramArray != null) {
            Array[][] arrayOfArray = this.paramArray;
            this.paramArray = new Array[j][i];
            for (byte b = 0; b < this.allocatedBatchRowCount; b++)
                System.arraycopy(arrayOfArray[b], 0, this.paramArray[b], 0, this.bindParamCnt);
        }
    ...
    void setAsciiStreamInternal(int paramInt1, InputStream paramInputStream, int len) throws SQLException {
        if (paramInputStream == null || len <= 0) {
        ...
        int i = 0;
        try {
            i = paramInputStream.read(arrayOfByte, 0, bufLen);
        ...
        if (i < 0) {
            ...
            if (this.paramStream == null)
                this.paramStream = new InputStream[this.allocatedBatchRowCount][this.bindParamCnt];
            this.bindData.setDFRParam(paramInt1 - 1, -1, len);
    ...
    void setBinaryStreamInternal(int paramInt1, InputStream paramInputStream, int len) throws SQLException {
        if (paramInputStream == null || len <= 0) {
        ...
        if (i < 0) {
            ...
            if (this.paramStream == null)
                this.paramStream = new InputStream[this.allocatedBatchRowCount][this.bindParamCnt];
            this.bindData.setDFRParam(paramInt1 - 1, -4, len);
            this.paramStream[this.currentRowIndex][paramInt1 - 1] = (InputStream) new BytesStreamWrapper(paramInputStream, arrayOfByte, i);
            this.binder[this.currentRowIndex][paramInt1 - 1] = this.staticStreamBinder;
    ...
    void setBlobInternal(int paramInt, Blob paramBlob) throws SQLException {
        ...
        if (this.paramBytes == null)
            this.paramBytes = new byte[this.allocatedBatchRowCount][this.bindParamCnt][];
        this.bindData.setINParam(paramInt - 1, -2, (((TbLob) paramBlob).getLocator()).length);
    ...
    public void setNull(int paramInt1, int paramInt2, String paramString) throws SQLException {
        ...
        this.paramTypes[this.currentRowIndex][paramInt1 - 1] = (byte) i;
        if (i == 32) {
            if (this.paramStruct == null)
                this.paramStruct = (Struct[][]) new TbStruct[this.allocatedBatchRowCount][this.bindParamCnt];
            this.binder[this.currentRowIndex][paramInt1 - 1] = this.staticStructInBinder;
            this.paramStruct[this.currentRowIndex][paramInt1 - 1] = null;
            TbStructDescriptor tbStructDescriptor = ((TbStruct) this.conn.createStruct(paramString, null)).getDescriptor();
            this.bindData.getBindItem(paramInt1 - 1).setTypeDescriptor((TbTypeDescriptor) tbStructDescriptor);
        } else if (i == 29) {
            if (this.paramArray == null)
                this.paramArray = (Array[][]) new TbArray[this.allocatedBatchRowCount][this.bindParamCnt];
            this.binder[this.currentRowIndex][paramInt1 - 1] = this.staticArrayInBinder;
            this.paramArray[this.currentRowIndex][paramInt1 - 1] = null;
            TbArrayDescriptor tbArrayDescriptor = ((TbArray) this.conn.createArrayOf(paramString, null)).getDescriptor();
            this.bindData.getBindItem(paramInt1 - 1).setTypeDescriptor((TbTypeDescriptor) tbArrayDescriptor);
        } else {
            throw TbError.newSQLException(-590703, DataType.getDBTypeName(i));
        }
    }
    ...
    void setObjectInternal(int paramInt1, Object paramObject, int paramInt2, int paramInt3) throws SQLException {
        ...
        switch (paramInt2) {
            ...
            case 12:
                ...
                } else if (this.conn.getFixedString().equalsIgnoreCase("true")) {
                    setFixedCHARInternal(paramInt1, paramObject.toString());
                } else {
            ...
            case 91:
                ...
                } else if (paramObject instanceof LocalDate) {
                    setDateInternal(paramInt1, Date.valueOf((LocalDate) paramObject));
                } else if (paramObject instanceof LocalDateTime) {
                    setDateInternal(paramInt1, Date.valueOf(((LocalDateTime) paramObject).toLocalDate()));
                } else {
                    throw TbError.newSQLException(-590704, paramObject.toString() + "," + paramInt2);
                }
                return;
            case 92:
                ...
                } else if (paramObject instanceof LocalTime) {
                    LocalDateTime localDateTime = LocalDateTime.of(LocalDate.of(1970, 1, 1), (LocalTime) paramObject);
                    setTimestampInternal(paramInt1, toTimestamp(localDateTime));
                } else if (paramObject instanceof LocalDateTime) {
                    setTimestampInternal(paramInt1, toTimestamp((LocalDateTime) paramObject));
                } else if (paramObject instanceof OffsetTime) {
                    LocalTime localTime = ((OffsetTime) paramObject).toLocalTime();
            ...
            case 93:
                if (paramObject instanceof Timestamp) {
                    ...
                    setTimestampInternal(paramInt1, toTimestamp((LocalDateTime) paramObject));
                } else if (paramObject instanceof OffsetDateTime) {
                    LocalDateTime localDateTime = ((OffsetDateTime) paramObject).withOffsetSameInstant(ZoneOffset.UTC).toLocalDateTime();
                    TbTimestampTZ tbTimestampTZ = new TbTimestampTZ(toTimestamp(localDateTime), TimeZone.getTimeZone(((OffsetDateTime) paramObject).getOffset().normalized()));
                    setTbTimestampTZ(paramInt1, tbTimestampTZ);
                } else {
                    throw TbError.newSQLException(-590704, paramObject.toString() + "," + paramInt2);
                }
                return;
            case 2013:
                if (paramObject instanceof OffsetTime) {
                    LocalTime localTime = ((OffsetTime) paramObject).withOffsetSameInstant(ZoneOffset.UTC).toLocalTime();
                    LocalDateTime localDateTime = LocalDateTime.of(LocalDate.of(1970, 1, 1), localTime);
                    TbTimestampTZ tbTimestampTZ = new TbTimestampTZ(toTimestamp(localDateTime), TimeZone.getTimeZone(((OffsetTime) paramObject).getOffset().normalized()));
                    setTbTimestampTZ(paramInt1, tbTimestampTZ);
                } else if (paramObject instanceof OffsetDateTime) {
                    LocalTime localTime = ((OffsetDateTime) paramObject).withOffsetSameInstant(ZoneOffset.UTC).toLocalTime();
                    LocalDateTime localDateTime = LocalDateTime.of(LocalDate.of(1970, 1, 1), localTime);
                    TbTimestampTZ tbTimestampTZ = new TbTimestampTZ(toTimestamp(localDateTime), TimeZone.getTimeZone(((OffsetDateTime) paramObject).getOffset().normalized()));
                    setTbTimestampTZ(paramInt1, tbTimestampTZ);
                } else {
            ...
            case 2002:
                ...
                } else if (paramObject instanceof TbAnydata) {
                    setStructInternal(paramInt1, ((TbAnydata) paramObject).getStruct());
                } else {
                    throw TbError.newSQLException(-590704, paramObject.toString() + "," + paramInt2);
                }
                return;
    ...
    private void setStructInternal(int paramInt, Struct paramStruct) throws SQLException {
        ...
        this.bindData.setINParam(paramInt - 1, DataType.getSqlType(i), 0);
    ...
    void setTbTimestampTZ(int paramInt, TbTimestampTZ paramTbTimestampTZ) throws SQLException {
        if (paramTbTimestampTZ == null) {
            setNullInternal(paramInt, 21);
            return;
        }
        if (this.paramTbTimestampTZ == null)
            this.paramTbTimestampTZ = new TbTimestampTZ[this.allocatedBatchRowCount][this.bindParamCnt];
        this.bindData.setINParam(paramInt - 1, 2014, -1);
        this.paramTbTimestampTZ[this.currentRowIndex][paramInt - 1] = paramTbTimestampTZ;
        this.paramTypes[this.currentRowIndex][paramInt - 1] = 21;
        this.binder[this.currentRowIndex][paramInt - 1] = this.staticTimestampTZBinder;
    }
    ...
    private long executeLargeCompleteSQL(String paramString) throws SQLException, IOException {
        if (!isInsertStmt(paramString))
            this.returnAutoGeneratedKeys = false;
        if (TbSQLTypeScanner.isQueryStmt(this.sqlType)) {
            if (this.userRsetType.getType() == 1005 || this.userRsetType.getConcurrency() == 1008) {
                if (this.rsetTypeDowngraded) {
                    this.realRsetType = RsetType.getDownGradedRsetType(this.userRsetType.getRank());
                    synchronized (this.conn) {
                        long l = this.conn.getTbComm().prepareExecuteLarge(this, paramString, this.currentRowIndex);
                        this.rsetTypeDowngraded = true;
                        return l;
                    }
                }
                ...
                try {
                    this.realRsetType = this.userRsetType;
                    synchronized (this.conn) {
                        return this.conn.getTbComm().prepareExecuteLarge(this, this.sqlWithRowId, this.currentRowIndex);
                    }
                } catch (SQLException sQLException) {
                    this.realRsetType = RsetType.getDownGradedRsetType(this.userRsetType.getRank());
                    synchronized (this.conn) {
            ...
            try {
                this.realRsetType = this.userRsetType;
                synchronized (this.conn) {
                    return this.conn.getTbComm().prepareExecuteLarge(this, paramString, this.currentRowIndex);
                }
            } catch (SQLException sQLException) {
                this.ppid = null;
                if (this.conn.isClosed() || !this.conn.info.isFailoverCursorEnabled() || sQLException.getErrorCode() != -90700)
        ...
        if (TbSQLTypeScanner.isDMLStmt(this.sqlType) || (!TbSQLTypeScanner.isQueryStmt(this.sqlType) && !TbSQLTypeScanner.isPSMStmt(this.sqlType))) {
            ...
            synchronized (this.conn) {
                this.rowsUpdated = this.conn.getTbComm().prepareExecuteLarge(this, str, this.currentRowIndex);
            }
    ...
    protected synchronized long executeLargeInternal(String paramString) throws SQLException {
        int i = this.conn.typeConverter.getMaxBytesPerChar();
        if (paramString.length() > 65535 / i && this.sqlType != 128) {
            if (this.processedBigLiteralSql == null) {
                if (this.bigLiterals == null)
            ...
            if (this.bigLiterals.size() > 0)
                return executeLargeBigLiteral(this.processedBigLiteralSql, this.bigLiterals);
        }
        try {
            return executeLargeCompleteSQL(paramString);
        } catch (SQLException sQLException) {
            this.ppid = null;
            throw sQLException;
        } catch (IOException e) {
    ...
    private long executeLargeBigLiteral(String paramString, ArrayList<BigLiteral> paramArrayList) throws SQLException {
        addBigLiteral(paramArrayList);
        try {
            return executeLargeCompleteSQL(paramString);
        } catch (SQLException sQLException) {
    ...
    public long executeLargeUpdate() throws SQLException {
        ...
        try {
            this.isExecuting = true;
            return executeLargeInternal(this.originalSql);
        } finally {
            this.isExecuting = false;
            if (this.queryTimeout != 0)
                this.conn.getTimeout().cancelTimeout();
    ...
    private Timestamp toTimestamp(LocalDateTime paramLocalDateTime) {
        double d = paramLocalDateTime.getNano() / 1000.0D;
        int i = (int) Math.round(d) * 1000;
        return Timestamp.valueOf(paramLocalDateTime.withNano(i));
    }
}