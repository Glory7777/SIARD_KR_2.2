...
public class MS950Encoder implements CharsetEncoder {
  private MS950CharToByteConverter conv = null;
  
  private int maxBytesPerChar = 0;
  
  public MS950Encoder() {
    this.conv = new MS950CharToByteConverter();
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\MS950Encoder.class
