...
public class ISO8859P5Encoder implements CharsetEncoder {
  private ISO8859P5CharToByteConverter conv = null;
  
  private int maxBytesPerChar;
  
  public ISO8859P5Encoder() {
    this.conv = new ISO8859P5CharToByteConverter();
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\ISO8859P5Encoder.class
