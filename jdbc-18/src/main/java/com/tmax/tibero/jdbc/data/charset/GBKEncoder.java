...
public class GBKEncoder implements CharsetEncoder {
  private GBKCharToByteConverter conv = null;
  
  private int maxBytesPerChar = 0;
  
  public GBKEncoder() {
    this.conv = new GBKCharToByteConverter();
  ...
  public int stringToBytes(byte[] paramArrayOfbyte, int paramInt, String paramString) throws SQLException, UnsupportedEncodingException {
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\GBKEncoder.class
