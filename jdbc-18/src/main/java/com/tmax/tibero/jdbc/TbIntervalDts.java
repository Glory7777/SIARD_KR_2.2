...
public class TbIntervalDts {
  ...
  public String toString() {
    ...
    boolean bool = (i >= 0 && j >= 0 && k >= 0) ? true : false;
    i = Math.abs(i);
    j = Math.abs(j);
    int m = j / 3600;
    j -= m * 3600;
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\TbIntervalDts.class
