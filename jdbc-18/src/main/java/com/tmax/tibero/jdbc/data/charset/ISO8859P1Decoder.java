...
public class ISO8859P1Decoder implements CharsetDecoder {
  private ISO8859P1ByteToCharConverter conv = null;
  
  public ISO8859P1Decoder() {
    this.conv = new ISO8859P1ByteToCharConverter();
  }
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\ISO8859P1Decoder.class
