...
public class SingleByteDecoder implements CharsetDecoder {
  private static ByteToCharSingleByte conv;
  
  SingleByteDecoder(String paramString) {
    conv = new ByteToCharSingleByte(paramString);
  }
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\SingleByteDecoder.class
