...
public class DPLBigDecimalBinder extends DPLBinder {
  public void bind(TbConnection paramTbConnection, TbDirPathStream paramTbDirPathStream, TbStreamDataWriter paramTbStreamDataWriter, int paramInt1, int paramInt2) throws SQLException {
    ...
    BigDecimal bigDecimal = paramTbDirPathStream.getParamBigDecimal(paramInt1);
    ...
    int j = dataTypeConverter.castFromBigDecimal(arrayOfByte, m, bigDecimal, i);
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\dpl\binder\DPLBigDecimalBinder.class
