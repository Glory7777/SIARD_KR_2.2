...
public class TbResultSetMetaData implements com.tmax.tibero.jdbc.TbResultSetMetaData {
    ...
    public String getColumnClassName(int paramInt) throws SQLException {
        checkColumnIndex(paramInt);
        return (getColumnDataType(paramInt) == 5 && this.columnInfoArr[paramInt - 1].getMapDateToTimestamp()) ? DataType.getDataTypeClassName(7) : DataType.getDataTypeClassName(getColumnDataType(paramInt));
    }
