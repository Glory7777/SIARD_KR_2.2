...
public class JA16SJISEncoder implements CharsetEncoder {
  private JA16SJISCharToByteConverter conv = null;
  
  private int maxBytesPerChar = 0;
  
  public JA16SJISEncoder() {
    this.conv = new JA16SJISCharToByteConverter();
...
/* Location:              C:\Users\lenovo\Desktop\siard\jdbc\tibero\tibero6\linux\tibero6-jdbc-18.jar!\com\tmax\tibero\jdbc\data\charset\JA16SJISEncoder.class
